...
feature -- Test routines
	...
	test_e2e_1
		...
		note
			...
			testing: "covers/{HTML_RENDERER}.render_italic", "covers/{HTML_RENDERER}.render_quote", "covers/{HTML_RENDERER}.render_title", "covers/{HTML_RENDERER}.render_underline", "covers/{HTML_RENDERER}.render_anchor"
		local
			yoda: YODA
